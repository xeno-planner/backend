...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Repos\\Web\\TypeScript\\Study projects\\XENO Planner\\xeno-planner-backend\\packages\\types",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "de7fcf274a7a65191a6bbf5f0f71dcb653146d986b773e451522c686f2e74a38",
  "copyEngine": true
}
...
path.join(process.cwd(), "packages/types/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/types/schema.prisma")
